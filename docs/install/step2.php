    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            <header>
                ...
                <h1 class="text-center">LIMS Auto Installer</h1>
            </header>
            <hr>
            <div class="content">
                <?php
                ...
                if (version_compare(PHP_VERSION, '7.1') >= 0) {
                    ...
                    $ltext .= '<i class="fa fa-close"></i>LIMS needs at least PHP version  7.1, Your PHP Version is: ' . PHP_VERSION . '<br/>';
                    $passed .= '0';
                }
                ...
                <br/><?php echo $ltext; ?><br/><h4>Great! System Test Completed. You can run LIMS on your server. Click Continue For Next Step.</h4>
                <a href="step3.php" class="btn btn-primary">Continue</a>

                <?php else: ?>

                <br/><?php echo $ltext; ?><br/>Sorry. The requirements of LIMS is not available on your server. Please contact with us- hello@lion-coders.com with this code- <?php echo $passed; ?> Or contact with your server administrator.<br><br>
