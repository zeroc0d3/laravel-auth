...
# Unsecure Deploy
# server '192.168.1.20', user: 'root', roles: %w{app web db}

# Secure Deploy
# server '192.168.1.20', user: 'root', port: 22, password: fetch(:password), roles: %w{app web db}
server '192.168.1.20', user: 'root', port: 22, roles: %w{app web db}

# Default branch is :master
set :branch, "dev-master"

# Default deploy_to directory is /var/www/my_app_name
set :root_path, "/data/www/laravel-auth"
